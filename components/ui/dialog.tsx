...
const dialogVariants = cva(
  "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border-2 border-brutal-black bg-brutal-cream p-6 shadow-brutal-md duration-200 sm:rounded-lg",
  {
    variants: {
      variant: {
        default: "",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={clsx("font-mono text-sm text-brutal-stone", className)}
    {...props}
  />
));
